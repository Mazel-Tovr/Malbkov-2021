...
public class RunTest {
    ...
    public static void TrainerTest() {
        ...
        NeocognitronTrainer trainer = new NeocognitronTrainer(inputs, testInputs, new File("D:\\malich\\Neocognitron-Java-master\\data\\Saved Networks\\BestNeocognitron" + dateFormat.format(new Date()) + ".neo"));
